...
-FriendlyName "GreeterTest1RootCert" `
...
-FriendlyName "GreeterTest1ClientCert" `
...
-Subject "CN=localhost" -KeyExportPolicy Exportable `
-DnsName "localhost" `
-FriendlyName "GreeterTest1TlsCert" `
-HashAlgorithm sha256 -KeyLength 2048 `
...
$PFXPass = ConvertTo-SecureString -String "justTestPassword" -Force -AsPlainText

Write-Host "Exporting Certificates to File"

Export-PfxCertificate -Cert $clientCert `
-Password $PFXPass `
-FilePath GreeterTest1SelfCert.pfx

Export-PfxCertificate -Cert $webCert `
-Password $PFXPass `
-FilePath GreeterTest1SslCert.pfx
